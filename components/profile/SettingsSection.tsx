    ...
    <div className="glass card-dark rounded-lg p-4 space-y-4">
      ...
      <div className="space-y-2">
        <label className="block text-sm text-gray-300">
          {t.settings.timerStep}
        </label>
        <p className="text-xs text-gray-500">
          {t.settings.timerStepDesc}
        </p>
        <div className="flex items-center justify-center gap-3 flex-wrap">
          <input
            ...
            className="w-24 px-3 py-2 rounded-lg bg-white/10 border border-white/20 text-white text-center focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
          <button
            type="button"
      ...
      <div className="border-t border-white/10 pt-4 space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className={`btn-glass ${
              language === 'ru' ? 'btn-glass-primary' : 'btn-glass-secondary'
          ...
          <button
            ...
            className={`btn-glass ${
              language === 'en' ? 'btn-glass-primary' : 'btn-glass-secondary'
            } w-full py-2! px-3! font-medium transition-all duration-200 ease-out`}
          >
            <span className="flex items-center justify-center gap-2">
