export const ru = {
    ...
    templates: {
        ...
        archiving: 'В архив...',
        archiveError: 'Не удалось добавить в архив.',
        archiveLoading: 'Загрузка архива...',
        archiveEmpty: 'В архиве пока нет шаблонов.',
        archiveLoadError: 'Не удалось загрузить архив.',
        restore: 'Восстановить',
        restoring: 'Восстановление...',
        restoreSelected: 'Восстановить выбранные',
        restoreError: 'Не удалось восстановить шаблоны.',
    ...
    progress: {
        ...
        sort: {
            ...
            lastAdded: 'По последнему подходу',
            mostFrequent: 'По частоте выполнения',
        },
        period: {
            all: 'Все данные',
